...
const UUID = process.env.UUID || '98dfb91d-3ecf-4326-a1b9-b86d2be98542'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || '98dfb91d-3ecf-4326-a1b9-b86d2be98542';            // 获取节点的订阅路径
